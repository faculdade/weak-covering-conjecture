...
## Theorem 16, Empirical Results 17 and 18, and the 1547 counterexample
...
the set occupies a single class mod 9 (Empirical Result 18), and that the class follows
...
Verifies Lemma 14's width dictionary against known holdout sizes, the death-parity theorem, and
